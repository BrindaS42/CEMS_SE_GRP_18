            ...
            <div className="relative">
              <div className="overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-900">
                ...
                >
                  ...
                  <div className="mt-4 p-2">
                    <h3 className="text-xl mb-2 dark:text-white">{ads[currentAdIndex].title}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{ads[currentAdIndex].description}</p>
                  </div>
                </motion.div>
              </div>
              ...
              {ads.length > 1 && (
                <>
                  <button
                    onClick={prevAd}
                    className="absolute left-2 top-1/3 -translate-y-1/2 bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 dark:text-white rounded-full p-2 shadow-lg backdrop-blur-sm"
                  >
                  ...
                  <button
                    onClick={nextAd}
                    className="absolute right-2 top-1/3 -translate-y-1/2 bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 dark:text-white rounded-full p-2 shadow-lg backdrop-blur-sm"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
