        ...
        {!loading && filteredSponsors.length > 0 && (
          ...
          >
            {filteredSponsors.map((sponsor, index) => (
              ...
              >
                <Card className="p-6 hover:shadow-xl transition-all group cursor-pointer border-2 hover:border-purple-300">
                  <div className="flex items-start gap-4 mb-4">
                    {/* Logo */}
                    <div className="w-16 h-16 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex items-center gap-4 mb-4 text-sm text-gray-500">
                    {sponsor.totalAds && (
                      <div className="flex items-center gap-1">
                        <Badge variant="outline">{sponsor.totalAds} Ads</Badge>
                      </div>
                    )}
                  </div>
