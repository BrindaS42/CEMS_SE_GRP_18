...
import { CustomFormFieldsBuilder, CustomField } from "../components/CustomFormFieldsBuilder";
...
interface EventFormData {
  ...
  registrationType: "single" | "duo" | "team";
  teamMemberCount?: number;
  comboOption: "silver" | "gold" | "platinum";
  venue: string;
  venueCoordinates?: {
    lat: number;
    lng: number;
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) => setValue("comboOption", value as "silver" | "gold" | "platinum")}
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => setValue("registrationType", value as "single" | "duo" | "team")}
                className="grid grid-cols-1 md:grid-cols-3 gap-4"
              >
