              ...
              <Alert className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
                <AlertDescription>
                  ...
                  <ul className="text-sm space-y-1 text-purple-800">
                    <li><strong>Student:</strong> student@college.edu</li>
                    <li><strong>Organizer:</strong> organizer@college.edu</li>
                    <li><strong>Sponsor:</strong> sponsor@company.com</li>
                    <li><strong>Admin:</strong> admin@college.edu</li>
