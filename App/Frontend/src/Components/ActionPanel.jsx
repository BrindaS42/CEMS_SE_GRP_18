    ...
    <div className="w-full space-y-4">
      ...
      <div className="relative">
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-college-blue">
            Quick Actions
          </h2>
          <Button
            size="sm"
      ...
      <div className="space-y-3">
        {actionItems.map((item, index) => (
          ...
          >
            ...
            <div
              className={`absolute top-0 right-0 w-0 h-0 border-l-[15px] border-l-transparent border-t-[15px] ${
                index === 0
                  ? "border-t-college-blue"
                  : index === 1
                  ? "border-t-college-yellow"
            ...
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-medium text-sm mb-1 text-college-blue">
                    {item.title}
                  </h3>
