...
import collegeLogoPng from 'figma:asset/2a26e7b07e46ed18f64283a59e00a4c804d3f7a6.png';
...
export function Header() {
  ...
  const { currentPage, sidebarPanelHovered } = useSelector((state: RootState) => state.ui);
