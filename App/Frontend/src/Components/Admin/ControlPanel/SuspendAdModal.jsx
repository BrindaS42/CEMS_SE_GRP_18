  ...
  return (
    <Dialog open={open} onOpenChange={(open) => { onOpenChange(open); if (!open) setReason(''); }}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Suspend Advertisement</DialogTitle>
        </DialogHeader>

        <div className="space-y-4 mt-4">
          <p className="text-sm text-muted-foreground">
            You are about to suspend the ad <strong>{ad.title}</strong>. Please provide a reason for suspension.
          </p>
